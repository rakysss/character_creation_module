...
def attack(char_name: str, char_class: str) -> str:
    """Отображение нанесенного уровна противнику от выбранного персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Отображение возможности блокировки урона выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Отображение специального умения выбранного персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Начало тренировки навыков выбранного персонажа."""
    if char_class == 'warrior':
